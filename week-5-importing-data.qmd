---
title: "Import Data - Theresa Binnings"
format: html
...
In almost every case, you can ignore whether or not you are working with tibbles or data frames, but occasionally a function might require one or the other (you will get an error that indicates that).
...
```{r}
#| label: write-csv
write_csv(nimbus, file = "data/clean/nimbus_clean.csv")
...
gsw <- read_csv("data/GSWdata.csv", na = "N/A",
                col_types = list('2019-20'=col_skip(), '2020-21' = col_number(),
                                 'FG%' = col_number(), '3P%' = col_number()))
```
